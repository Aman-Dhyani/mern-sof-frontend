                                    ...
                                    <div className='fbuser-post-div'>
                                        {
                                            allposts?.resourceType === "image" ?
                                                <Image onClick={() => navigate(`/fbclone/${allposts?._id}`)} className="fb-posted-img" cloudName={cloud} publicId={allposts?.publicId} /> :
                                                <Video controls onClick={() => navigate(`/fbclone/${allposts?._id}`)} className="fb-posted-img" cloudName={cloud} publicId={allposts?.publicId} >
